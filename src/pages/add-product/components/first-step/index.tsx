...
const ImageUpload: React.FC = () => {
    ...
    const { images, handleImageUpload, handleReplaceImage, setPrimaryImage, setSelectedImage, removeImage } = useImageUpload();
    ...
    return (
        <>
            <StyledFormContainer>
                ...
                <ImageUploader error={errors.images?.message} handleImageUpload={handleImageUpload} />
